...
struct ShelfLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: ShelfActivityAttributes.self) { context in
            ...
            DynamicIsland {
                DynamicIslandExpandedRegion(.leading) {
                    Label("Shelved", systemImage: "books.vertical.fill")
...
private struct LockScreenView: View {
    let context: ActivityViewContext<ShelfActivityAttributes>
