...
final class AppState: ObservableObject {
    ...
    /// Set when the app comes to the foreground because of the "Clam up my phone" intent.
    @Published var pendingIntentMinutes: Int?

    /// Reads and clears the minutes left behind by `StartClamSessionIntent`, if any.
