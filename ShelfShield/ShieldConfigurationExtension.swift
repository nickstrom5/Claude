...
final class ShieldConfigurationExtension: ShieldConfigurationDataSource {
    ...
    override func configuration(shielding application: Application) -> ShieldConfiguration {
        shelfConfiguration(appName: application.localizedDisplayName)
    }
    ...
    override func configuration(shielding webDomain: WebDomain) -> ShieldConfiguration {
        shelfConfiguration(appName: webDomain.domain)
    }
    ...
    private func shelfConfiguration(appName: String?) -> ShieldConfiguration {
        ...
        return ShieldConfiguration(
            ...
            title: ShieldConfiguration.Label(text: "\(name) is on the shelf", color: .white),
