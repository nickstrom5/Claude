...
| 5 | **Reveal** | "This might help" | Animated: "At 4.5h/day that's **68 days a year**. Clam users cut it by ~40%: that's 27 days back." | The aha. Big number, animated count-up, screenshot-able. |
...
| 8 | **Result** | "I want the result" | "You just clammed up your phone for 1 minute. That's 1 of 27 days you'll get back." Share card offered. | Immediate win + the first shareable artifact. |
