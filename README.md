...
iPhone 17 Pro Max simulator in `docs/screenshots/` via the Screenshots workflow; `scripts/capture-screens.sh` does
the same on any simulator (Xcode 27.1) into `docs/screenshots/<device>/`, including the iPhone Duo. Landing page,
