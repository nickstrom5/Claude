...
struct HookScreen: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Text("Shelf locks the apps that steal your time. One tap. One fold.")
...
struct AppsScreen: View {
    ...
    var body: some View {
        OnboardingScreen(
            ...
            subtitle: "These are the ones Shelf will lock during a session. You can change them any time.",
        ...
        .alert("Screen Time access needed", isPresented: $showDeniedAlert) {
            ...
            Text("Shelf can only lock apps if iOS lets it. Allow Screen Time access for Shelf in Settings.")
        }
    }
}
...
struct PermissionScreen: View {
    ...
    var body: some View {
        OnboardingScreen(
            title: screenTime.isAuthorized ? "Shelf is allowed to lock your apps." : "Let Shelf lock the apps you picked.",
            subtitle: screenTime.isAuthorized
                ? "Everything stays on your phone. Shelf never sees what you do in them."
                : "iOS will ask for Screen Time access. Shelf uses it only to lock the apps you chose during a session. Nothing leaves your phone.",
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Image(systemName: "checkmark.seal.fill")
                ...
                .foregroundStyle(Theme.success)
                .padding(.bottom, 20)
            Text("You just shelved your phone.")
                .font(Theme.Font.title)
                .foregroundStyle(Theme.textPrimary)
                .multilineTextAlignment(.center)
            ...
            ShareCardView(title: "I shelved my phone", detail: "for the first time", streak: nil)
                .padding(.top, 28)
                .scaleEffect(0.9)
        ...
        .sheet(isPresented: $showShare) {
            ShareSheet(items: [ShareCardView(title: "I shelved my phone", detail: "for the first time", streak: nil).render()].compactMap { $0 })
        }
    }
}
